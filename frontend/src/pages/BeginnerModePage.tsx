...
import { searchMenuForBeginner, updateIngredientSelection } from '../services/api';
...
export default function BeginnerModePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-pink-50 to-yellow-50">
      ...
      {/* ChatBot Modal - TODO: 구현 필요 */}
      {isChatBotOpen && (
        <div className="fixed bottom-20 right-4 w-80 h-96 bg-white rounded-lg shadow-2xl z-50 border border-gray-200">
